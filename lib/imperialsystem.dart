...
import 'package:bmr_calculator/metricsystem.dart';

void main() => runApp(ImperialSystem());

class ImperialSystem extends StatefulWidget {
  @override
  _ImperialSystemState createState() => _ImperialSystemState();
}

class _ImperialSystemState extends State<ImperialSystem> {
        ...
        body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                    onTap: _onClick,
                    child: Text('Back to Metric system',
